...
function createUsernames (accounts) {
  accounts.forEach((acc) => {const usr=acc.owner.split(' ').map((str)=>str[0].toLowerCase()).join('')
  acc.userName=usr;
...
accounts.forEach(acc => acc.balance=calbalance(acc));



let currnetAccount=account1;

function updatUI(currentAccout){
...
// const somethingie= "ffjj dkls";
// console.log(omethingie.split(' ')
